...
//compile -> gcc -o randRead read_file_remote.c -lm
//run -> sudo ./randRead
int main(int argc, char* argv[]) {
    ...
    for (size_t i = 0; i < iterations; i++) {
        int fd_log7 = open("mount/fileread7.txt", O_RDONLY);
    ...
    for (size_t i = 0; i < iterations; i++) {
        int fd_log8 = open("mount/fileread8.txt", O_RDONLY);
    ...
    for (size_t i = 0; i < iterations; i++) {
        int fd_log9 = open("mount/fileread9.txt", O_RDONLY);
    ...
    for (size_t i = 0; i < iterations; i++) {
        int fd_log10 = open("mount/fileread10.txt", O_RDONLY);
    ...
    for (size_t i = 0; i < iterations; i++) {
        int fd_log11 = open("mount/fileread11.txt", O_RDONLY);
    ...
    for (size_t i = 0; i < iterations; i++) {
        int fd_log12 = open("mount/fileread12.txt", O_RDONLY);
    ...
    for (size_t i = 0; i < iterations; i++) {
        int fd_log13 = open("mount/fileread13.txt", O_RDONLY);
    ...
    for (size_t i = 0; i < iterations; i++) {
        int fd_log14 = open("mount/fileread14.txt", O_RDONLY);
    ...
    for (size_t i = 0; i < iterations; i++) {
        int fd_log15 = open("mount/fileread15.txt", O_RDONLY);
    ...
    for (size_t i = 0; i < iterations; i++) {
        int fd_log16 = open("mount/fileread16.txt", O_RDONLY);
    ...
    for (size_t i = 0; i < iterations; i++) {
        int fd_log17 = open("mount/fileread17.txt", O_RDONLY);
    ...
    for (size_t i = 0; i < iterations; i++) {
        int fd_log18 = open("mount/fileread18.txt", O_RDONLY);
    ...
    for (size_t i = 0; i < iterations; i++) {
        int fd_log19 = open("mount/fileread19.txt", O_RDONLY);
    ...
    for (size_t i = 0; i < iterations; i++) {
        int fd_log20 = open("mount/fileread20.txt", O_RDONLY);
    ...
    for (size_t i = 0; i < iterations; i++) {
        int fd_log21 = open("mount/fileread21.txt", O_RDONLY);
    ...
    for (size_t i = 0; i < iterations; i++) {
        int fd_log22 = open("mount/fileread22.txt", O_RDONLY);
    ...
    for (size_t i = 0; i < iterations; i++) {
        int fd_log23 = open("mount/fileread23.txt", O_RDONLY);
    ...
    for (size_t i = 0; i < iterations; i++) {
        int fd_log24 = open("mount/fileread24.txt", O_RDONLY);
    ...
    for (size_t i = 0; i < iterations; i++) {
        int fd_log25 = open("mount/fileread25.txt", O_RDONLY);
    ...
    for (size_t i = 0; i < iterations; i++) {
        int fd_log26 = open("mount/fileread26.txt", O_RDONLY);
    ...
    for (size_t i = 0; i < iterations; i++) {
        int fd_log27 = open("mount/fileread27.txt", O_RDONLY);
    ...
    for (size_t i = 0; i < iterations; i++) {
        int fd_log28 = open("mount/fileread28.txt", O_RDONLY);
    ...
    for (size_t i = 0; i < iterations; i++) {
        int fd_log29 = open("mount/fileread29.txt", O_RDONLY);
